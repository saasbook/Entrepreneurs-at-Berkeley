...
Also, config/application.yml is already in .gitignore. DO NOT REMOVE IT FROM .gitignore. Or else your private information (environment variables) will be visible to the public!
