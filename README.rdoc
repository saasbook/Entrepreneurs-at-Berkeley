...
(1) is an existing email account that uses gmail as its underlying email service (ie. blank@gmail.com or blank@berkeley.edu) and has some form of 2-step authentication
