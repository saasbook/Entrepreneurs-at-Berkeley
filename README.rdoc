...
(2) is the domain to (1) (ie. "gmail.com" if (1) is blank@gmail.com or "berkeley.edu" if (1) is blank@berkley.edu)
...
(3) depends on the type of account of (1)
  ...
  if (1) is a "berkeley.edu" account and does have 2-Step Authentication
    - then follow the steps 3-5 at https://berkeley.service-now.com/kb_view.do?sysparm_article=KB0010997
...
(4) is a string, and is the code required to register a regular account

(5) is a string different from (4), and is the code required to register an admin account

(6) is a string different from both (4) and (5), and is the code required to register a super-admin account
